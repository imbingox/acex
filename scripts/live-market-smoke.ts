...
async function smokeSymbol(options: {
  ...
  try {
    ...
    return {
      ...
      initialBook: {
        bidPrice: initialBook.bidPrice.toFixed(),
        bidSize: initialBook.bidSize.toFixed(),
        askPrice: initialBook.askPrice.toFixed(),
        askSize: initialBook.askSize.toFixed(),
        version: initialBook.version,
        exchangeTs: initialBook.exchangeTs,
        receivedAt: initialBook.receivedAt,
      },
      firstEvent: {
        bidPrice: firstEvent.snapshot.bidPrice.toFixed(),
        askPrice: firstEvent.snapshot.askPrice.toFixed(),
      ...
      marketCatalog: {
        ...
        spotMarket: spotMarket
          ? {
              ...
              priceStep: spotMarket.priceStep.toFixed(),
              amountStep: spotMarket.amountStep.toFixed(),
            }
          : null,
        perpMarket: perpMarket
          ? {
              ...
              priceStep: perpMarket.priceStep.toFixed(),
              amountStep: perpMarket.amountStep.toFixed(),
            }
          : null,
      },
      results,
